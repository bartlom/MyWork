...
public class Array220<checkNumber> {
...
*/
    ...
    public boolean array220(int[] nums, int index) {
        ...
        return multipleOfInt(nums, index, multipleOf) || array220(nums, index + 1);
    }

    public boolean multipleOfInt(int[] nums, int index, int multipleOf) {
