...
scoresSpecial([12, 11, 4], [2, 20, 31]) → 20
     ...
     */
    public static int[] a = new int[]{12, 10, 4};
    public static int[] b = new int[]{2, 20, 30};

    public static int scoresSpecial(int[] a, int[] b) {
        int result = helperScoresSpecial(a) + helperScoresSpecial(b);
        return result;
    }

    public static int helperScoresSpecial(int[] a) {
        int max = 0;
