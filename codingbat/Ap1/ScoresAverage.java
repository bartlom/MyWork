...
To practice decomposition, write a separate helper method int average(int[] scores,
...
scoresAverage([3, 4, 5, 1, 2, 3]) → 4
     ...
     */
    public static int[] scores = new int[]{3, 4, 5, 1, 2, 3};
